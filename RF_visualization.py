...
from RF_testing import depths, best_depth, best_f1, f1_score, f1_macros, f1_weighted_list, y_test, y_pred_best
...
plt.tight_layout()
plt.savefig("RF_f1_macro_by_depth.png", dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("RF_f1_macro_vs_weighted.png", dpi=150, bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("RF_per_class_metrics.png", dpi=150, bbox_inches="tight")
plt.show()
...
ax6.set_title("Confusion Matrix (Normalized %)",
              fontsize=13, fontweight="bold")
plt.tight_layout()
plt.savefig("RF_confusion_matrix_pct.png", dpi=150, bbox_inches="tight")
plt.show()
